...
#define WRONG_ARG_COUNT_ERR 102
#define READ_FILE_ERR 103
#define WRITE_FILE_ERR 104
#define STAT_FILE_ERR 105
#define WRONG_FILE_SIZE_ERR 106
#define SEEK_FILE_ERR 107
